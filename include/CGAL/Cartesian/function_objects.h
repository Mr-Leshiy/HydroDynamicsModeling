...
class Angle_2 {
 ...
 public:
  ...
  result_type operator()(const Point_2& p,
    ...
    return angleC2(p.x(), p.y(), q.x(), q.y(), r.x(), r.y(), s.x(), s.y());
  }
};
...
class Angle_3 {
 ...
 public:
  ...
  result_type operator()(const Vector_3& u, const Vector_3& v) const {
    return angleC3(u.x(), u.y(), u.z(), v.x(), v.y(), v.z());
  }
...
class Are_parallel_2 {
 ...
 public:
  ...
  result_type operator()(const Line_2& l1, const Line_2& l2) const {
    return parallelC2(l1.a(), l1.b(), l2.a(), l2.b());
  }

  result_type operator()(const Segment_2& s1, const Segment_2& s2) const {
    return parallelC2(s1.source().x(),
                      s1.source().y(),
                      s1.target().x(),
                      s1.target().y(),
                      s2.source().x(),
  ...
  result_type operator()(const Ray_2& r1, const Ray_2& r2) const {
    return parallelC2(r1.source().x(),
                      r1.source().y(),
                      r1.second_point().x(),
                      r1.second_point().y(),
                      r2.source().x(),
...
class Are_parallel_3 {
 ...
 public:
  ...
  result_type operator()(const Line_3& l1, const Line_3& l2) const {
    return parallelC3(l1.to_vector().x(),
                      l1.to_vector().y(),
                      l1.to_vector().z(),
                      l2.to_vector().x(),
                      l2.to_vector().y(),
  ...
  result_type operator()(const Plane_3& h1, const Plane_3& h2) const {
    return parallelC3(h1.a(), h1.b(), h1.c(), h2.a(), h2.b(), h2.c());
  }

  result_type operator()(const Segment_3& s1, const Segment_3& s2) const {
    return parallelC3(s1.source().x(),
                      s1.source().y(),
                      s1.source().z(),
                      s1.target().x(),
                      s1.target().y(),
  ...
  result_type operator()(const Ray_3& r1, const Ray_3& r2) const {
    return parallelC3(r1.source().x(),
                      r1.source().y(),
                      r1.source().z(),
                      r1.second_point().x(),
                      r1.second_point().y(),
...
class Bounded_side_2 {
 ...
 public:
  ...
  result_type operator()(const Circle_2& c, const Point_2& p) const {
    typename K::Compute_squared_distance_2 squared_distance;
    return enum_cast<Bounded_side>(
        CGAL::compare(c.squared_radius(), squared_distance(c.center(), p)));
  }
  ...
  result_type operator()(const Triangle_2& t, const Point_2& p) const {
    ...
    if (o2 == o1 && o3 == o1) return ON_BOUNDED_SIDE;
    return (o1 == COLLINEAR &&
            collinear_are_ordered_along_line(t.vertex(0), p, t.vertex(1))) ||
                   (o2 == COLLINEAR && collinear_are_ordered_along_line(
                                           t.vertex(1), p, t.vertex(2))) ||
                   (o3 == COLLINEAR && collinear_are_ordered_along_line(
                                           t.vertex(2), p, t.vertex(3)))
               ? ON_BOUNDARY
               : ON_UNBOUNDED_SIDE;
  }

  result_type operator()(const Iso_rectangle_2& r, const Point_2& p) const {
    bool x_incr = (r.xmin() < p.x()) && (p.x() < r.xmax()),
         y_incr = (r.ymin() < p.y()) && (p.y() < r.ymax());
    if (x_incr) {
      if (y_incr) return ON_BOUNDED_SIDE;
      if ((p.y() == r.ymin()) || (r.ymax() == p.y())) return ON_BOUNDARY;
    }
...
class Bounded_side_3 {
 ...
 public:
  ...
  result_type operator()(const Sphere_3& s, const Point_3& p) const {
    return s.rep().bounded_side(p);
  }

  result_type operator()(const Circle_3& s, const Point_3& p) const {
    return s.rep().bounded_side(p);
  }

  result_type operator()(const Tetrahedron_3& t, const Point_3& p) const {
    FT alpha, beta, gamma;
  ...
  result_type operator()(const Iso_cuboid_3& c, const Point_3& p) const {
...
class Collinear_has_on_2 {
 ...
 public:
  ...
  result_type operator()(const Ray_2& r, const Point_2& p) const {
...
class Compare_angle_with_x_axis_2 {
 ...
 public:
  ...
  result_type operator()(const Direction_2& d1, const Direction_2& d2) const {
...
class Compare_distance_2 {
 ...
 public:
  ...
  result_type operator()(const T1& p, const T2& q, const T3& r) const {
    return CGAL::compare(squared_distance(p, q), squared_distance(p, r));
  }

  template <class T1, class T2, class T3, class T4>
  result_type operator()(const T1& p,
                         const T2& q,
                         const T3& r,
                         const T4& s) const {
...
class Compare_distance_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p1,
                         const Segment_3& s1,
                         const Segment_3& s2) const {
...
class Compare_power_distance_2 {
 public:
  ...
  Comparison_result operator()(const Point_2& r,
    ...
    return CGAL::compare_power_distanceC2(
        p.x(), p.y(), p.weight(), q.x(), q.y(), q.weight(), r.x(), r.y());
  }
};
...
class Compare_squared_radius_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p,
                         ...
                         const Point_3& s,
                         const FT& ft) const {
    return CGAL::compare(squared_radiusC3(p.x(),
                                          p.y(),
                                          p.z(),
                                          q.x(),
                                          q.y(),
  ...
  result_type operator()(const Point_3& p,
                         ...
                         const FT& ft) const {
    return CGAL::compare(
        squared_radiusC3(p.x(), p.y(), p.z(), q.x(), q.y(), q.z()), ft);
  }

  result_type operator()(const Point_3&, const FT& ft) const {
...
class Compare_slope_2 {
 ...
 public:
  ...
  result_type operator()(const Segment_2& s1, const Segment_2& s2) const {
    return compare_slopesC2(s1.source().x(),
                            s1.source().y(),
                            s1.target().x(),
                            s1.target().y(),
                            s2.source().x(),
...
class Compare_x_at_y_2 {
 ...
 public:
  ...
  result_type operator()(const Point_2& p, const Line_2& h) const {
    return compare_y_at_xC2(p.y(), p.x(), h.b(), h.a(), h.c());
  }

  result_type operator()(const Point_2& p,
                         const Line_2& h1,
                         const Line_2& h2) const {
    return compare_y_at_xC2(
        p.y(), h1.b(), h1.a(), h1.c(), h2.b(), h2.a(), h2.c());
  }

  result_type operator()(const Line_2& l1,
                         const Line_2& l2,
                         const Line_2& h) const {
    return compare_y_at_xC2(
        l1.b(), l1.a(), l1.c(), l2.b(), l2.a(), l2.c(), h.b(), h.a(), h.c());
  }
...
class Compare_x_2 {
 ...
 public:
  ...
  result_type operator()(const Line_2& l,
                         const Line_2& h1,
                         const Line_2& h2) const {
    return compare_xC2(
        l.a(), l.b(), l.c(), h1.a(), h1.b(), h1.c(), h2.a(), h2.b(), h2.c());
  }
...
class Compare_y_at_x_2 {
 ...
 public:
  ...
  result_type operator()(const Point_2& p,
                         ...
                         const Line_2& h2) const {
    return compare_y_at_xC2(
        p.x(), h1.a(), h1.b(), h1.c(), h2.a(), h2.b(), h2.c());
  }
  ...
  result_type operator()(const Line_2& l1,
                         ...
                         const Line_2& h) const {
    return compare_y_at_xC2(
        l1.a(), l1.b(), l1.c(), l2.a(), l2.b(), l2.c(), h.a(), h.b(), h.c());
  }
  ...
  result_type operator()(const Point_2& p, const Segment_2& s) const {
    return compare_y_at_xC2(p.x(),
                            p.y(),
                            s.source().x(),
                            s.source().y(),
                            s.target().x(),
...
class Compute_area_2 {
 ...
 public:
  ...
  result_type operator()(const Iso_rectangle_2& r) const {
    return (r.xmax() - r.xmin()) * (r.ymax() - r.ymin());
  }

  result_type operator()(const Triangle_2& t) const { return t.area(); }
};
...
class Compute_determinant_2 {
 ...
 public:
  ...
  result_type operator()(const Vector_2& v, const Vector_2& w) const {
...
class Compute_determinant_3 {
 ...
 public:
  ...
  result_type operator()(const Vector_3& v,
                         const Vector_3& w,
                         const Vector_3& t) const {
    return determinant(
        v.x(), v.y(), v.z(), w.x(), w.y(), w.z(), t.x(), t.y(), t.z());
  }
};
...
class Compute_scalar_product_3 {
 ...
 public:
  ...
  result_type operator()(const Vector_3& v, const Vector_3& w) const {
...
class Compute_squared_radius_2 {
 ...
 public:
  ...
  result_type operator()(const Point_2& /*p*/) const { return FT(0); }
...
class Compute_squared_radius_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& /*p*/) const { return FT(0); }

  result_type operator()(const Point_3& p, const Point_3& q) const {
    return squared_radiusC3(p.x(), p.y(), p.z(), q.x(), q.y(), q.z());
  }

  result_type operator()(const Point_3& p,
                         const Point_3& q,
                         const Point_3& r) const {
    return squared_radiusC3(
        p.x(), p.y(), p.z(), q.x(), q.y(), q.z(), r.x(), r.y(), r.z());
  }
...
class Compute_volume_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p0,
                         const Point_3& p1,
                         const Point_3& p2,
                         const Point_3& p3) const {
    return determinant<FT>(p1.x() - p0.x(),
                           p1.y() - p0.y(),
                           p1.z() - p0.z(),
                           p2.x() - p0.x(),
                           p2.y() - p0.y(),
  ...
  result_type operator()(const Tetrahedron_3& t) const {
    return this->operator()(t.vertex(0), t.vertex(1), t.vertex(2), t.vertex(3));
  }

  result_type operator()(const Iso_cuboid_3& c) const {
    return c.rep().volume();
  }
};
...
class Compute_x_2 {
 ...
 public:
  ...
  result_type operator()(const Point_2& p) const { return p.rep().x(); }

  result_type operator()(const Vector_2& v) const { return v.rep().x(); }
};
...
class Compute_x_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p) const { return p.rep().x(); }

  result_type operator()(const Vector_3& v) const { return v.rep().x(); }
};
...
class Compute_y_2 {
 ...
 public:
  ...
  result_type operator()(const Point_2& p) const { return p.rep().y(); }

  result_type operator()(const Vector_2& v) const { return v.rep().y(); }
};
...
class Compute_y_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p) const { return p.rep().y(); }

  result_type operator()(const Vector_3& v) const { return v.rep().y(); }
};
...
class Compute_z_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p) const { return p.rep().z(); }

  result_type operator()(const Vector_3& v) const { return v.rep().z(); }
};
...
class Compute_dx_2 {
 ...
 public:
  ...
  result_type operator()(const Direction_2& d) const { return d.rep().dx(); }
};
...
class Compute_dx_3 {
 ...
 public:
  ...
  result_type operator()(const Direction_3& d) const { return d.rep().dx(); }
};
...
class Compute_dy_2 {
 ...
 public:
  ...
  result_type operator()(const Direction_2& d) const { return d.rep().dy(); }
};
...
class Compute_dy_3 {
 ...
 public:
  ...
  result_type operator()(const Direction_3& d) const { return d.rep().dy(); }
};
...
class Compute_dz_3 {
 ...
 public:
  ...
  result_type operator()(const Direction_3& d) const { return d.rep().dz(); }
};
...
class Compute_hx_2 {
 ...
 public:
  ...
  result_type operator()(const Point_2& p) const { return p.rep().hx(); }

  result_type operator()(const Vector_2& v) const { return v.rep().hx(); }
};
...
class Compute_hx_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p) const { return p.rep().hx(); }

  result_type operator()(const Vector_3& v) const { return v.rep().hx(); }
};
...
class Compute_hy_2 {
 ...
 public:
  ...
  result_type operator()(const Point_2& p) const { return p.rep().hy(); }

  result_type operator()(const Vector_2& v) const { return v.rep().hy(); }
};
...
class Compute_hy_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p) const { return p.rep().hy(); }

  result_type operator()(const Vector_3& v) const { return v.rep().hy(); }
};
...
class Compute_hz_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p) const { return p.rep().hz(); }

  result_type operator()(const Vector_3& v) const { return v.rep().hz(); }
};
...
class Compute_hw_2 {
 ...
 public:
  ...
  result_type operator()(const Point_2& p) const { return p.rep().hw(); }

  result_type operator()(const Vector_2& v) const { return v.rep().hw(); }
};
...
class Compute_hw_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p) const { return p.rep().hw(); }

  result_type operator()(const Vector_3& v) const { return v.rep().hw(); }
};
...
class Construct_barycenter_2 {
 ...
 public:
  ...
  result_type operator()(const Point_2& p1,
                         const FT& w1,
  ...
  result_type operator()(const Point_2& p1,
    ...
    FT x, y;
    barycenterC2(
        p1.x(), p1.y(), w1, p2.x(), p2.y(), w2, p3.x(), p3.y(), w3, x, y);
    return construct_point_2(x, y);
  }
...
class Construct_barycenter_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p1,
    ...
    FT x, y, z;
    barycenterC3(
        p1.x(), p1.y(), p1.z(), w1, p2.x(), p2.y(), p2.z(), w2, x, y, z);
    return construct_point_3(x, y, z);
  }
...
class Construct_base_vector_3 {
  ...
  typedef
      typename K::Construct_orthogonal_vector_3 Construct_orthogonal_vector_3;
 ...
 public:
  ...
  result_type operator()(const Plane_3& h, int index) const {
    if (index == 1) {
      ...
      FT a = CGAL::abs(h.a()), b = CGAL::abs(h.b()), c = CGAL::abs(h.c());
      ...
      if (a <= b && a <= c) return Vector_3(FT(0), -h.c(), h.b());

      if (b <= a && b <= c) return Vector_3(-h.c(), FT(0), h.a());
...
class Construct_bbox_2 {
 ...
 public:
  ...
  result_type operator()(const Segment_2& s) const {
    return s.source().bbox() + s.target().bbox();
  }

  result_type operator()(const Triangle_2& t) const {
...
class Construct_bbox_3 {
 ...
 public:
  ...
  Bbox_3 operator()(const Point_3& p) const {
    ...
    return Bbox_3(
        xp.first, yp.first, zp.first, xp.second, yp.second, zp.second);
  }

  Bbox_3 operator()(const Segment_3& s) const {
    return s.source().bbox() + s.target().bbox();
  }

  Bbox_3 operator()(const Triangle_3& t) const {
  ...
  Bbox_3 operator()(const Iso_cuboid_3& r) const {
    typename K::Construct_bbox_3 construct_bbox_3;
    return construct_bbox_3((r.min)()) + construct_bbox_3((r.max)());
  }

  Bbox_3 operator()(const Tetrahedron_3& t) const {
    typename K::Construct_bbox_3 construct_bbox_3;
    return construct_bbox_3(t.vertex(0)) + construct_bbox_3(t.vertex(1)) +
           construct_bbox_3(t.vertex(2)) + construct_bbox_3(t.vertex(3));
  }

  Bbox_3 operator()(const Sphere_3& s) const {
    typename K::Construct_bbox_3 construct_bbox_3;
    ...
    return Bbox_3(
        minx.inf(), miny.inf(), minz.inf(), maxx.sup(), maxy.sup(), maxz.sup());
  }

  Bbox_3 operator()(const Circle_3& c) const { return c.rep().bbox(); }
};
...
class Construct_bisector_2 {
 ...
 public:
  ...
  result_type operator()(const Line_2& p, const Line_2& q) const {
    FT a, b, c;
    bisector_of_linesC2(p.a(), p.b(), p.c(), q.a(), q.b(), q.c(), a, b, c);
    return Line_2(a, b, c);
  }
};
...
class Construct_bisector_3 {
 ...
 public:
  ...
  result_type operator()(const Plane_3& p, const Plane_3& q) const {
    FT a, b, c, d;
    bisector_of_planesC3(
        p.a(), p.b(), p.c(), p.d(), q.a(), q.b(), q.c(), q.d(), a, b, c, d);
    return Plane_3(a, b, c, d);
  }
};
...
class Construct_centroid_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p,
    ...
    FT x, y, z;
    centroidC3(
        p.x(), p.y(), p.z(), q.x(), q.y(), q.z(), r.x(), r.y(), r.z(), x, y, z);
    return construct_point_3(x, y, z);
  }
...
class Construct_circumcenter_3 {
 ...
 public:
  ...
  Point_3 operator()(const Point_3& p, const Point_3& q) const {
  ...
  Point_3 operator()(const Point_3& p,
    ...
    FT den = determinant(psx, psy, psz, qsx, qsy, qsz, rsx, rsy, rsz);
  ...
  Point_3 operator()(const Triangle_3& t) const {
    return this->operator()(t.vertex(0), t.vertex(1), t.vertex(2));
  }
  ...
  Point_3 operator()(const Point_3& p,
    ...
    FT num_x = determinant(qpy, qpz, qp2, rpy, rpz, rp2, spy, spz, sp2);
    FT num_y = determinant(qpx, qpz, qp2, rpx, rpz, rp2, spx, spz, sp2);
    FT num_z = determinant(qpx, qpy, qp2, rpx, rpy, rp2, spx, spy, sp2);
    FT den = determinant(qpx, qpy, qpz, rpx, rpy, rpz, spx, spy, spz);
  ...
  Point_3 operator()(const Tetrahedron_3& t) const {
    return this->operator()(t.vertex(0), t.vertex(1), t.vertex(2), t.vertex(3));
  }
};
...
class Construct_cross_product_vector_3 {
 ...
 public:
  ...
  Vector_3 operator()(const Vector_3& v, const Vector_3& w) const {
...
class Construct_lifted_point_3 {
 ...
 public:
  ...
  Point_3 operator()(const Plane_3& h, const Point_2& p) const {
...
class Construct_direction_2 {
 ...
 public:
  ...
  Direction_2 operator()(const RT& x, const RT& y) const {
...
class Construct_direction_3 {
 ...
 public:
  ...
  Direction_3 operator()(const RT& x, const RT& y, const RT& z) const {
...
class Construct_equidistant_line_3 {
 ...
 public:
  ...
  Line_3 operator()(const Point_3& p,
                    const Point_3& q,
                    const Point_3& s) const {
...
class Construct_iso_rectangle_2 {
 ...
 public:
  ...
  operator()(Return_base_tag, const Point_2& p, const Point_2& q) const {
    ...
    return Rep(Point_2(minx, miny), Point_2(maxx, maxy), 0);
  }
  ...
  operator()(Return_base_tag,
             const Point_2& left,
             const Point_2& right,
             const Point_2& bottom,
             const Point_2& top) const {
    ...
    return Rep(Point_2(left.x(), bottom.y()), Point_2(right.x(), top.y()), 0);
  }
  ...
  operator()(Return_base_tag,
             ...
             const RT& min_hy,
             const RT& max_hx,
             const RT& max_hy) const {
    CGAL_kernel_precondition(min_hx <= max_hx);
    CGAL_kernel_precondition(min_hy <= max_hy);
    return Rep(Point_2(min_hx, min_hy), Point_2(max_hx, max_hy), 0);
  }
  ...
  Iso_rectangle_2 operator()(const Point_2& p, const Point_2& q, int i) const {
    return this->operator()(Return_base_tag(), p, q, i);
  }

  Iso_rectangle_2 operator()(const Point_2& p, const Point_2& q) const {
    return this->operator()(Return_base_tag(), p, q);
  }

  Iso_rectangle_2 operator()(const Point_2& left,
                             const Point_2& right,
                             const Point_2& bottom,
                             const Point_2& top) const {
  ...
  Iso_rectangle_2 operator()(const RT& min_hx,
                             const RT& min_hy,
                             const RT& max_hx,
                             const RT& max_hy) const {
  ...
  Iso_rectangle_2 operator()(const RT& min_hx,
    ...
    return this->operator()(
        Return_base_tag(), min_hx, min_hy, max_hx, max_hy, hw);
  }
};
...
class Construct_line_2 {
 ...
 public:
  ...
  Line_2 operator()(const RT& a, const RT& b, const RT& cc) const {
    return this->operator()(Return_base_tag(), a, b, cc);
  }

  Line_2 operator()(const Point_2& p, const Point_2& q) const {
    return this->operator()(Return_base_tag(), p, q);
  }
...
class Construct_line_3 {
 ...
 public:
  ...
  Line_3 operator()(const Point_3& p, const Vector_3& v) const {
    return this->operator()(Return_base_tag(), p, v);
  }
...
class Construct_difference_of_vectors_2 {
 ...
 public:
  ...
  Vector_2 operator()(const Vector_2& v, const Vector_2& w) const {
...
class Construct_radical_axis_2 {
 public:
  ...
  Line_2 operator()(const Weighted_point_2& p,
                    const Weighted_point_2& q) const {
    typedef typename K::RT RT;
    RT a, b, c;
...
class Construct_orthogonal_vector_3 {
 ...
 public:
  ...
  Vector_3 operator()(const Plane_3& p) const {
...
class Construct_perpendicular_vector_2 {
 ...
 public:
  ...
  Vector_2 operator()(const Vector_2& v, Orientation o) const {
...
class Construct_perpendicular_direction_2 {
 ...
 public:
  ...
  Direction_2 operator()(const Direction_2& d, Orientation o) const {
    CGAL_kernel_precondition(o != COLLINEAR);
    if (o == COUNTERCLOCKWISE)
...
class Construct_point_2 {
 ...
 public:
  ...
  Point_2 operator()(const Line_2& l, const FT i) const {
    typename K::Construct_point_2 construct_point_2;
    typename K::FT x, y;
  ...
  const Point_2& operator()(const Weighted_point_2& p) const {
    return p.rep().point();
  }

  Point_2 operator()(Origin o) const { return Point_2(o); }

  Point_2 operator()(const RT& x, const RT& y) const { return Point_2(x, y); }
...
class Construct_point_3 {
 ...
 public:
  ...
  Point_3 operator()(Origin o) const { return Point_3(o); }

  Point_3 operator()(const RT& x, const RT& y, const RT& z) const {
    return Point_3(x, y, z);
  }

  Point_3 operator()(const RT& x,
                     const RT& y,
                     const RT& z,
                     HParticle* el) const {
    return Point_3(x, y, z, el);
  }
...
class Construct_weighted_point_2 {
 ...
 public:
  ...
  Rep operator()(Return_base_tag, Origin o) const { return Rep(o); }

  Rep operator()(Return_base_tag, const Point_2& p, const FT& w) const {
    return Rep(p, w);
  }

  Rep operator()(Return_base_tag, const FT& x, const FT& y) const {
    return Rep(x, y);
  }

  Weighted_point_2 operator()(Origin o) const { return Weighted_point_2(o); }

  Weighted_point_2 operator()(const Point_2& p, const FT& w) const {
    return Weighted_point_2(p, w);
  }

  Weighted_point_2 operator()(const FT& x, const FT& y) const {
    return Weighted_point_2(x, y);
  }

  Weighted_point_2 operator()(const Point_2& p) const {
    return Weighted_point_2(p, 0);
  }

  const Weighted_point_2& operator()(const Weighted_point_2& wp) const {
    return wp;
  }
};
...
class Construct_weighted_point_3 {
 ...
 public:
  ...
  Rep operator()(Return_base_tag, const Point_3& p, const FT& w) const {
    return Rep(p, w);
  }

  Rep operator()(Return_base_tag, const FT& x, const FT& y, const FT& z) const {
    return Rep(x, y, z);
  }

  Weighted_point_3 operator()(Origin o) const { return Weighted_point_3(o); }

  Weighted_point_3 operator()(const Point_3& p, const FT& w) const {
    return Rep(p, w);
  }

  Weighted_point_3 operator()(const FT& x, const FT& y, const FT& z) const {
    return Weighted_point_3(x, y, z);
  }

  Weighted_point_3 operator()(const Point_3& p) const {
    return Weighted_point_3(p, 0);
  }

  const Weighted_point_3& operator()(const Weighted_point_3& wp) const {
    return wp;
  }
};
...
class Construct_projected_point_3 {
 ...
 public:
  ...
  Point_3 operator()(const Line_3& l, const Point_3& p) const {
    ...
    FT dpy = p.y() - lpy;
    FT dpz = p.z() - lpz;
    FT lambda = (ldx * dpx + ldy * dpy + ldz * dpz) /
                (ldx * ldx + ldy * ldy + ldz * ldz);
    return Point_3(lpx + lambda * ldx, lpy + lambda * ldy, lpz + lambda * ldz);
  }

  Point_3 operator()(const Plane_3& h, const Point_3& p) const {
  ...
  Point_3 operator()(const Segment_3& s, const Point_3& p) const {
    return CommonKernelFunctors::Construct_projected_point_3<K>()(p, s, K());
  }

  Point_3 operator()(const Ray_3& r, const Point_3& p) const {
...
class Construct_radical_line_2 {
 ...
 public:
  ...
  result_type operator()(const Circle_2& c1, const Circle_2& c2) const {
    ...
    const FT c = CGAL::square(c1.center().x()) + CGAL::square(c1.center().y()) -
                 c1.squared_radius() - CGAL::square(c2.center().x()) -
...
class Construct_radical_plane_3 {
 ...
 public:
  ...
  result_type operator()(const Sphere_3& s1, const Sphere_3& s2) const {
    ...
    const FT d = CGAL::square(s1.center().x()) + CGAL::square(s1.center().y()) +
                 CGAL::square(s1.center().z()) - s1.squared_radius() -
                 CGAL::square(s2.center().x()) - CGAL::square(s2.center().y()) -
...
class Construct_scaled_vector_2 {
 ...
 public:
  ...
  Vector_2 operator()(const Vector_2& v, const FT& c) const {
...
class Construct_divided_vector_3 {
 ...
 public:
  ...
  Vector_3 operator()(const Vector_3& v, const FT& c) const {
...
class Construct_scaled_vector_3 {
 ...
 public:
  ...
  Vector_3 operator()(const Vector_3& w, const FT& c) const {
...
class Construct_vector_2 {
 ...
 public:
  ...
  Vector_2 operator()(Return_base_tag, const Segment_2& s) const {
    return s.to_vector();
  }

  Vector_2 operator()(Return_base_tag, const Ray_2& r) const {
    return r.to_vector();
  }
  ...
  Vector_2 operator()(const Origin& o, const Point_2& q) const {
    return this->operator()(Return_base_tag(), o, q);
  }

  Vector_2 operator()(const Point_2& p, const Origin& o) const {
  ...
  Vector_2 operator()(const Segment_2& s) const {
    return this->operator()(Return_base_tag(), s);
  }

  Vector_2 operator()(const Ray_2& r) const {
    return this->operator()(Return_base_tag(), r);
  }

  Vector_2 operator()(const Line_2& l) const {
    return this->operator()(Return_base_tag(), l);
  }

  Vector_2 operator()(Null_vector n) const {
    return this->operator()(Return_base_tag(), n);
  }

  Vector_2 operator()(const RT& x, const RT& y) const {
    return this->operator()(Return_base_tag(), x, y);
  }
...
class Construct_vector_3 {
 ...
 public:
  ...
  Vector_3 operator()(const Point_3& p, const Point_3& q) const {
    return this->operator()(Return_base_tag(), p, q);
  }

  Vector_3 operator()(const Origin& o, const Point_3& q) const {
    return this->operator()(Return_base_tag(), o, q);
  }

  Vector_3 operator()(const Point_3& p, const Origin& q) const {
    return this->operator()(Return_base_tag(), p, q);
  }

  Vector_3 operator()(const Direction_3& d) const {
    return this->operator()(Return_base_tag(), d);
  }

  Vector_3 operator()(const Segment_3& s) const {
    return this->operator()(Return_base_tag(), s);
  }

  Vector_3 operator()(const Ray_3& r) const {
    return this->operator()(Return_base_tag(), r);
  }

  Vector_3 operator()(const Line_3& l) const {
    return this->operator()(Return_base_tag(), l);
  }

  Vector_3 operator()(const Null_vector& n) const {
    return this->operator()(Return_base_tag(), n);
  }

  Vector_3 operator()(int x, int y, int z) const {
    return this->operator()(Return_base_tag(), x, y, z);
  }

  Vector_3 operator()(const RT& x, const RT& y, const RT& z) const {
    return this->operator()(Return_base_tag(), x, y, z);
  }

  Vector_3 operator()(const RT& x,
                      const RT& y,
                      const RT& z,
                      const RT& w) const {
...
class Construct_vertex_2 {
 ...
 public:
  ...
  const Point_2& operator()(const Segment_2& s, int i) const {
    return s.vertex(i);
  }

  const Point_2& operator()(const Triangle_2& t, int i) const {
  ...
  Point_2 operator()(const Iso_rectangle_2& r, int i) const {
    switch (i % 4) {
      case 0:
        return (r.min)();
      case 1:
        return Point_2(r.xmax(), r.ymin());
      case 2:
        return (r.max)();
      default:
        return Point_2(r.xmin(), r.ymax());
    }
  }
};
...
class Coplanar_orientation_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p,
    ...
    return coplanar_orientationC3(p.x(),
                                  p.y(),
                                  p.z(),
                                  q.x(),
                                  q.y(),
...
class Coplanar_side_of_bounded_circle_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p,
    ...
    CGAL_kernel_exactness_precondition(!cl(p, q, r));
    return coplanar_side_of_bounded_circleC3(p.x(),
                                             p.y(),
                                             p.z(),
                                             q.x(),
                                             q.y(),
...
class Has_on_3 {
 ...
 public:
  ...
  result_type operator()(const Line_3& l, const Point_3& p) const {
    return l.rep().has_on(p);
  }

  result_type operator()(const Ray_3& r, const Point_3& p) const {
  ...
  result_type operator()(const Plane_3& pl, const Point_3& p) const {
    return pl.rep().has_on(p);
  }

  result_type operator()(const Plane_3& pl, const Line_3& l) const {
  ...
  result_type operator()(const Triangle_3& t, const Point_3& p) const {
    ...
    Vector_3 v0 = t.vertex(0) - o, v1 = t.vertex(1) - o, v2 = t.vertex(2) - o;
  ...
  result_type operator()(const Circle_3& a, const Point_3& p) const {
    return a.rep().has_on(p);
  }

  result_type operator()(const Sphere_3& a, const Circle_3& p) const {
    return a.rep().has_on(p);
  }

  result_type operator()(const Sphere_3& a, const Point_3& p) const {
    return a.rep().has_on(p);
  }

  result_type operator()(const Plane_3& a, const Circle_3& p) const {
    return a.rep().has_on(p);
  }
};
...
class Less_signed_distance_to_line_2 {
 ...
 public:
  ...
  result_type operator()(const Point_2& a,
                         const Point_2& b,
                         const Point_2& c,
...
class Less_signed_distance_to_plane_3 {
 ...
 public:
  ...
  result_type operator()(const Plane_3& h,
                         const Point_3& p,
                         const Point_3& q) const {
    return has_smaller_signed_dist_to_directionC3(
        h.a(), h.b(), h.c(), p.x(), p.y(), p.z(), q.x(), q.y(), q.z());
  }

  result_type operator()(const Point_3& hp,
                         const Point_3& hq,
                         const Point_3& hr,
                         const Point_3& p,
                         const Point_3& q) const {
    ...
    return has_smaller_signed_dist_to_planeC3(hp.x(),
                                              hp.y(),
                                              hp.z(),
                                              hq.x(),
                                              hq.y(),
...
class Orientation_3 {
 ...
 public:
  ...
  result_type operator()(const Vector_3& u,
                         const Vector_3& v,
                         const Vector_3& w) const {
...
class Power_side_of_oriented_power_circle_2 {
 public:
  ...
  Oriented_side operator()(const Weighted_point_2& p,
    ...
    return power_side_of_oriented_power_circleC2(p.x(),
                                                 p.y(),
                                                 p.weight(),
                                                 q.x(),
                                                 q.y(),
  ...
  Oriented_side operator()(const Weighted_point_2& p,
    ...
    return power_side_of_oriented_power_circleC2(p.point().x(),
                                                 p.y(),
                                                 p.weight(),
                                                 q.x(),
                                                 q.y(),
...
class Oriented_side_2 {
 ...
 public:
  ...
  result_type operator()(const Line_2& l, const Point_2& p) const {
 ...
 public:
  ...
  result_type operator()(const Point_2& p,
    ...
    return side_of_bounded_circleC2(
        p.x(), p.y(), q.x(), q.y(), r.x(), r.y(), t.x(), t.y());
  }
};
 ...
 public:
  ...
  result_type operator()(const Point_3& p,
    ...
    return side_of_bounded_sphereC3(
        p.x(), p.y(), p.z(), q.x(), q.y(), q.z(), test.x(), test.y(), test.z());
  }
  ...
  result_type operator()(const Point_3& p,
                         ...
                         const Point_3& r,
                         const Point_3& test) const {
    return side_of_bounded_sphereC3(p.x(),
                                    p.y(),
                                    p.z(),
                                    q.x(),
                                    q.y(),
...
class Side_of_oriented_sphere_3 {
 ...
 public:
  ...
  result_type operator()(const Point_3& p,
                         ...
                         const Point_3& s,
                         const Point_3& test) const {
    return side_of_oriented_sphereC3(p.x(),
                                     p.y(),
                                     p.z(),
                                     q.x(),
                                     q.y(),
