// Copyright (c) 1999-2004,2006-2009,2014-2015   INRIA Sophia-Antipolis
...
class Periodic_3_construct_point_3 : public Construct_point_3_base_ {
 ...
 public:
  Periodic_3_construct_point_3(const Iso_cuboid_3* dom, const Base& cp)
      : Base(cp), _dom(dom) {}
